...
sequenceDiagram
    ...
    Client->>Hub API: GET /user/me (Загрузка профиля и начального трафика)
    ...
    alt Соединение разорвано
        ...
        Client->>Hub API: GET /user/me (Получение свежего состояния трафика)
